...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--pic_a_path", type=str, default='/mnt/storage1/izzet/STSM/sample_images/arda_turan.png', help="Person who provides identity information")
        self.parser.add_argument("--pic_b_path", type=str, default='/mnt/storage1/izzet/STSM/sample_images/mehmet_demirkol.png', help="Person who provides information other than their identity")
